...
<body>
    ...
    <div id="header">
      <h1>430的乌托邦</h1>
      <p>人可以从单纯变得复杂，却再也不能从复杂变得单纯。</p>
    </div>
     <!--header end-->
    <!--nav-->
     <div id="nav">
         <ul>
             <li><a href="/Myblog/page?pagenum=1">我们的故事</a></li>
             <li><a href="/Myblog/tech?pagenum=1">技术专区</a></li>
             <li><a href="/showResourse">资源专区</a></li>
             <li><a href="/Myblog/Shortwords">只言片语</a></li>
             <!--<li><a href="/View/riji.html">个人日记</a></li>-->
             <li><a href="/View/xc.ftl">相册展示</a></li>
         <div class="clear"></div>
        </ul>
      </div>
       <!--nav end-->
       ...
       <!--left-->
         <div class="left" id="learn">
           ...
           <div class="wz">
            <h3><a href="#" title="浅谈：html5和html的区别">浅谈：html5和html的区别</a></h3>
             <dl>
               ...
               html5+css3也逐渐的成为新一代web前端技术${ctx}${ctx}.</p>
               <p class="dd_text_2">
           ...
           <div class="wz">
            <h3><a href="#" title="浅谈：html5和html的区别">浅谈：html5和html的区别</a></h3>
             <dl>
               <dt><img src="${ctx}/images/s1.jpg" width="200" height="123" alt=""></dt>
               <dd>
                 <p class="dd_text_1">最近看群里聊天聊得最火热的莫过于手机网站和html5这两个词。可能有人会问，这两者有什么关系呢？随着这移动互联
                 网快速发展的时代，尤其是4G时代已经来临的时刻，加上微软对"XP系统"不提供更新补丁、维护的情况下。
               html5+css3也逐渐的成为新一代web前端技术${ctx}${ctx}.</p>
